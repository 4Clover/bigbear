    ...
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      ...
      <form onSubmit={(e) => { void handleSubmit(e); }} className="space-y-4">
        <div>
          ...
          {photos.length === 0 && (
            <p className="mt-1 text-sm text-gray-500">Please upload at least one photo</p>
          )}
        </div>
        ...
        <div>
          <label htmlFor="materialsUsed" className="block text-sm font-medium text-gray-700 mb-1">
            Materials Used
          </label>
          <textarea
            id="materialsUsed"
        ...
        <div>
          <label htmlFor="unexpectedIssues" className="block text-sm font-medium text-gray-700 mb-1">
            Unexpected Issues
          </label>
          <textarea
            id="unexpectedIssues"
