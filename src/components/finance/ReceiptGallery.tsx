  ...
  const handleDelete = (receiptId: string) => {
    ...
    startTransition(async () => {
      try {
        ...
        console.error('Failed to delete receipt:', _error)
        ...
        {receipts.map((receipt) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
              ...
              {canDelete && confirmingId !== receipt.id && (
                <button
                  onClick={() => {
              ...
              {canDelete && confirmingId === receipt.id && (
                <div className="flex gap-1">
                  <button
                    ...
                    disabled={isPending}
                    className="px-2 py-1.5 bg-destructive text-destructive-foreground text-xs font-medium rounded-lg hover:bg-destructive/90 disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    disabled={isPending}
                    className="px-2 py-1.5 bg-card text-card-foreground text-xs font-medium rounded-lg hover:bg-muted"
                  >
                    Cancel
                  </button>
                </div>
